...
$mail->Body    = "Chào".$first_name."
\nĐể bắt đầu quá trình đặt lại mật khẩu cho,
\nTài khoản baby: ".$email." của bạn, hãy nhấp vào liên kết bên dưới:
\n".BASE_URL."retrieve_pass.php?x=".urlencode($email)."&y={$uid}&z=".$a."
...
if (!$mail->send()) {
    ...
    echo'<script>alert("Yêu cầu của quý khách đã được thực hiện, check email: '.$_POST['email'].' để lấy lại mật khẩu. !")</script>';
